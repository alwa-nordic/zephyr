...
/* This is the singleton used by the Zephyr Host. */
struct bt_scan_reassembler_state bt_scan_reassembler_state_global = {
 ...
 * isr-ok
 */
void bt_scan_reassembler_hci_reset(struct bt_scan_reassembler_state *state);
